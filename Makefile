filesToDelete = unitTesting testingMain Aggregate Arrangement Bonsai Command Condition Customer Dead Employee Espalier Gardener Inventory InventoryManager Kokedama main mainwindow Maturity Namer Normal Nursery Order OrderComponent OrderState Plant Request Salesman Supplier Topiary
